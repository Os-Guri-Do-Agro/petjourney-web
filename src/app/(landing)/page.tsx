...
export default function Home() {
  ...
  const ItensSaudePet = [
    {
      ...
      description:
        "Carteirinha, papéis, Whatsapp e memória- tudo desconectado.",
    },
    {
      id: 2,
      icon: Calendar,
  ...
  return (
    <main className="w-full max-w-[100vw] overflow-x-hidden">
      ...
      <section className="flex w-full px-5 md:px-20 lg:px-20 xl:px-40 2xl:px-70 bg-linear-to-b from-[#1D3557] via-[#1d3557d3] py-10">
        <div className=" flex flex-col w-full items-center justify-center gap-15">
          <div className="w-full flex align-center justify-center">
            <h2 className="text-center text-2xl md:text-3xl lg:text-4xl font-bold text-[#FAF9F6]">
              O problema da saúde pet hoje
            </h2>
          </div>
          <div
            ref={problemsRef}
            className="w-full flex gap-5 md:gap-10 items-center justify-center flex-wrap md:flex-nowrap"
          >
            {ItensSaudePet.map((item) => {
              const Icon = item.icon;
              return (
                <div
                  className="w-full flex flex-col items-center justify-center gap-5 p-5 bg-[#FAF9F6] rounded-3xl shadow-lg md:h-full"
                  key={item.id}
                >
                  ...
                  <div className="text-center flex flex-col gap-3">
                    ...
                    <p className="max-w-90 text-[#457B9D] text-lg">
                      {item.description}
                    </p>
                  </div>
                </div>
      ...
      <section className="w-full flex justify-center py-20 bg-[#FAF9F6] px-5 md:px-20 lg:px-20 xl:px-40 2xl:px-70 overflow-hidden">
        <div className="w-full flex flex-col lg:flex-row gap-16">
          <div ref={marketplaceRef} className="lg:w-1/2 space-y-6">
            ...
            <div className="text-[#457B9D] text-lg leading-relaxed space-y-2">
              ...
              <p>
                Cadastre informações, anexe exames, registre vacinas e mantenha
                tudo acessível sempre que precisar.
              </p>
              <p>
                Esta é a primeira etapa da construção de uma base sólida de
                cuidado contínuo
              </p>
            </div>
          </div>
      ...
      <section className="flex py-20 w-full">
        <div className="w-full bg-[url('../assets/home/home-cat-banner.jpg')] bg-no-repeat bg-center bg-cover flex min-h-150 items-center px-5 md:px-20 lg:px-20 xl:px-40 2xl:px-70 justify-start h-full md:p-10">
          <div
            ref={benefitsRef}
            className="w-full h-full flex flex-col justify-center gap-5 md:p-10 lg:p-10 rounded-2xl md:bg-linear-to-r from-black/30 max-w-3xl"
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#FaF9F6] leading-snug">
              Por que tutores e veterinários <br />
              vão amar a PetJourney
            </h2>

            <ul className="flex flex-col gap-2 ">
              <li className="text-xl md:text-2xl text-[#FAF9F6] list-disc ml-5 md:ml-10">
              ...
              <li className="text-xl md:text-2xl text-[#FAF9F6] list-disc ml-5 md:ml-10">
                Apoio ao diagnóstico veterinário
              </li>
            </ul>
              ...
              <button
                ...
                onClick={() => {
                  event({
                    action: "click",
                    category: "cta",
                    label: "Home Beneficios - Sou Tutor",
                  });
                  router.push("/tutor");
                }}
              >
              ...
              <button
                ...
                onClick={() => {
                  event({
                    action: "click",
                    category: "cta",
                    label: "Home Beneficios - Sou Veterinario",
                  });
      ...
      <section className="w-full py-20 px-5 md:px-20 lg:px-20 xl:px-40 2xl:px-70 bg-linear-to-br from-[#1D3557] via-[#457b9d] to-[#1D3557] relative overflow-hidden">
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-3xl border border-white/20 hover:bg-white/15 md:mt-12">
              ...
              <p className="text-[#FAF9F6]/90 text-lg leading-relaxed">
                ...
                respeitando sua privacidade e direitos.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-3xl border border-white/20 hover:bg-white/15 ">
              ...
              <p className="text-[#FAF9F6]/90 text-lg leading-relaxed">
                Você decide quem pode acessar as informações do seu pet.
                Compartilhe com veterinários de forma segura e controlada.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-3xl border border-white/20 hover:bg-white/15 md:mt-12">
              ...
              <p className="text-[#FAF9F6]/90 text-lg leading-relaxed">
                Nenhum dado é compartilhado sem sua autorização prévia.
      ...
      <section className="w-full flex justify-center bg-[#FAF9F6] overflow-hidden">
        <div className="w-full bg-[url('../assets/home/bgFooter-home.jpg')] bg-no-repeat bg-center bg-cover flex min-h-170 items-center px-5 md:px-20 lg:px-20 xl:px-40 2xl:px-70 justify-end">
          <div
            ref={finalRef}
            className="bg-white/30 w-200 p-10 min-h-100 rounded-4xl flex flex-col items-center text-center justify-center gap-10"
          >
            ...
            <div className="flex gap-5 flex-wrap">
              <button
                className="px-5 py-4 bg-linear-to-bl from-[#457b9d] to-[#1D3557] hover:bg-linear-to-r hover:from-[#457b9d] hover:to-[#1D3557] rounded-2xl font-bold text-white max-w-70 cursor-pointer"
                onClick={() => {
                  event({
                    action: "click",
                    category: "cta",
                    label: "Home Footer - Lista de Espera",
                  });
                  window.open("/lista-espera", "_blank");
                }}
              >
              ...
              <button
                className="border-2 border-white text-white bg-[#000000af] px-3 py-3 rounded-xl font-semibold shadow-lg hover:bg-[#FAF9F6] duration-300 transition-colors cursor-pointer hover:text-[#1D3557] hover:border-white"
                onClick={() => {
                  event({
                    action: "click",
                    category: "cta",
                    label: "Home Footer - Saiba Mais",
                  });
                  router.push("/tutor");
                }}
              >
